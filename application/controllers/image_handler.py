...
def upload_author_image(author_id) :
    ...
    else : return jsonify( success = False, body = 'Failed to upload author profile-image' )
...
def upload_project_image(project_id) :
    ...
    else : return jsonify( success = False, body = 'Failed to upload project image' )
...
def upload_work_image(work_id) :
    ...
    else : return jsonify( success = False, body = 'Failed to upload work image' )